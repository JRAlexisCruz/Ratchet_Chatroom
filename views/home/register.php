...
<body class="d-flex flex-column align-items-center">
    <main class="d-flex flex-column">
        <form action="action.php" id="register" class="mt-3" method="post">
            ...
            <div class="row justify-content-center align-items-center mt-3">
                ...
                <button type="submit" class="btn btn-primary submitButton">Register</button>
            </div>
        </form>
        <p class="mt-1 align-self-center">Already have an account? Go to <a href="index.php">login</a></p>
    </main>
